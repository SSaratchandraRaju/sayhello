...
class OnlineUsersService {
  ...
  Future<void> setCurrentUser(UserModel user) async {
    ...
    try {
      ...
      debugPrint('[ONLINE_USERS] RTM initialization failed: $e');
  ...
  void simulateOnlineUsers() {
    ...
    debugPrint('[ONLINE_USERS] RTM handles online status - simulation not needed');
  }
  ...
  Future<void> loadCurrentUser() async {
    ...
    if (userId != null && userName != null) {
      ...
      debugPrint('[ONLINE_USERS] Loaded user from storage: $userName ($userId)');
    }
  }
